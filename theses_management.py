...
def add_thesis_and_supervisor(cursor, ppn, nom, prenom, list_ppn_superviseur, list_nom_superviseur, list_prenom_superviseur, thesis_id, thesis_title, thesis_year):
    ...
    if result is None:
        # On ajoute la thèse à la database
        ...
        for (ppn_superviseur, nom_superviseur, prenom_superviseur) in zip(list_ppn_superviseur, list_nom_superviseur, list_prenom_superviseur):
            ...
            # On ajoute le superviseur à la thèse
            ...
            # On ajoute le superviseur en temps que nouvelle personne qui n'a pas été processed
